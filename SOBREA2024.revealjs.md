...
- A hipótese de que o erro é aditivo pode não ser verificada no mercado 
imobiliário:
...
- Análise da variável `Frente` *após* a homogeneização com o
fator `Area`:
...
- Não é possível utilizar fatores do tipo: $\left(\frac{X_{imóvel}}{X_{paradigma}}\right)^\alpha$ 
de forma aditiva
...
- O método de @lima2006 funciona!
  ...
  - Assim, o valor de $\beta_0$ se igualou ao valor do imóvel paradigma e
